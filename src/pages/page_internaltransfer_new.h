...
#ifndef PAGE_INTERNALTRANSFER_NEW_H
#define PAGE_INTERNALTRANSFER_NEW_H
...
class Page_InternalTransfer_New : public QWidget
{
Q_OBJECT
private:
	aqb_Accounts *accounts;
	const aqb_banking *banking;
	BankAccountsWidget *accountwidget_1;
	BankAccountsWidget *accountwidget_2;
	QLineEdit* verw1;
	QLineEdit* verw2;
	QLineEdit* verw3;
	QLineEdit* verw4;
...
#endif // PAGE_INTERNALTRANSFER_NEW_H
