...
abt_transaction::abt_transaction(AB_TRANSACTION *t, bool freeOnDelete)
{
	...
	if (t == NULL) {
		//Keine Transaction übergeben, wir erstellen uns selber eine
                this->m_aqb_transaction = AB_Transaction_new();
		//Diese muss zum Schluss durch uns auch wieder gelöscht werden
                this->m_FreeTransactionOnDelete = true;
	} else {
		//Übergebene Transaction nutzen
                this->m_aqb_transaction = t;
		//Löschen nur auf Aufforderung (default: false)
                this->m_FreeTransactionOnDelete = freeOnDelete;
	}
	...
	//(Alle nicht ändernden Aktionen werden mit diesem Zeiger durchgeführt)
        this->m_aqb_transaction_C = this->m_aqb_transaction;
}
...
abt_transaction::abt_transaction(const AB_TRANSACTION *t)
{
	...
	Q_ASSERT(t != NULL);
        ...
        this->m_aqb_transaction = NULL; //keine Änderbare Transaction vorhanden!
	//Diese muss zum Schluss auch nicht wieder gelöscht werden
        this->m_FreeTransactionOnDelete = false;

	//Übergebene constant Transaction nutzen
        this->m_aqb_transaction_C = t;
}
...
{
        if (this->m_FreeTransactionOnDelete) {
                AB_Transaction_free(this->m_aqb_transaction);
	}
}
...
{
        return (AB_Transaction_IsModified(this->m_aqb_transaction) == 0);
}
...
void abt_transaction::setModified(bool mod)
{
	...
	//m = (mod) ? 1 : 0;
        ...
        AB_Transaction_SetModified(this->m_aqb_transaction, mod);
}

void abt_transaction::fillLocalFromAccount(const AB_ACCOUNT *a)
{
        AB_Transaction_FillLocalFromAccount(this->m_aqb_transaction, a);
}

const AB_TRANSACTION* abt_transaction::getAB_Transaction() const
{
        return this->m_aqb_transaction;
}
...
const QString abt_transaction::getLocalCountry() const
{
	...
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalCountry(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalCountry(const QString &Country)
{
        AB_Transaction_SetLocalCountry(this->m_aqb_transaction,
				       Country.toUtf8());
}
...
const QString abt_transaction::getLocalBankCode() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalBankCode(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalBankCode(const QString &BankCode)
{
        AB_Transaction_SetLocalBankCode(this->m_aqb_transaction,
					BankCode.toUtf8());
}
...
const QString abt_transaction::getLocalBranchId() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalBranchId(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalBranchId(const QString &BranchId)
{
        AB_Transaction_SetLocalBranchId(this->m_aqb_transaction,
					BranchId.toUtf8());
}
...
const QString abt_transaction::getLocalAccountNumber() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalAccountNumber(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalAccountNumber(const QString &AccountNumber)
{
        AB_Transaction_SetLocalAccountNumber(this->m_aqb_transaction,
...
const QString abt_transaction::getLocalSuffix() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalSuffix(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalSuffix(const QString &Suffix)
{
        AB_Transaction_SetLocalSuffix(this->m_aqb_transaction,
				      Suffix.toUtf8());
}
...
const QString abt_transaction::getLocalIban() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalIban(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalIban(const QString &Iban)
{
        AB_Transaction_SetLocalIban(this->m_aqb_transaction,
				    Iban.toUtf8());
}
...
const QString abt_transaction::getLocalName() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalName(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalName(const QString &Name)
{
        AB_Transaction_SetLocalName(this->m_aqb_transaction,
				    Name.toUtf8());
}
...
const QString abt_transaction::getLocalBic() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetLocalBic(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setLocalBic(const QString &Bic)
{
        AB_Transaction_SetLocalBic(this->m_aqb_transaction,
				   Bic.toUtf8());
}
...
const QString abt_transaction::getRemoteCountry() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteCountry(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteCountry(const QString &Country)
{
        AB_Transaction_SetRemoteCountry(this->m_aqb_transaction,
					Country.toUtf8());
}
...
const QString abt_transaction::getRemoteBankName() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteBankName(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteBankName(const QString &BankName)
{
        AB_Transaction_SetRemoteBankName(this->m_aqb_transaction,
					 BankName.toUtf8());
}
...
const QString abt_transaction::getRemoteBankLocation() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteBankLocation(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteBankLocation(const QString &BankLocation)
{
        AB_Transaction_SetRemoteBankLocation(this->m_aqb_transaction,
					     BankLocation.toUtf8());
}
...
const QString abt_transaction::getRemoteBankCode() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteBankCode(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteBankCode(const QString &BankCode)
{
        AB_Transaction_SetRemoteBankCode(this->m_aqb_transaction,
					 BankCode.toUtf8());
}
...
const QString abt_transaction::getRemoteBranchId() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteBranchId(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteBranchId(const QString &BranchId)
{
        AB_Transaction_SetRemoteBranchId(this->m_aqb_transaction,
					 BranchId.toUtf8());
}
...
const QString abt_transaction::getRemoteAccountNumber() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteAccountNumber(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteAccountNumber(const QString &AccountNumber)
{
        AB_Transaction_SetRemoteAccountNumber(this->m_aqb_transaction,
					      AccountNumber.toUtf8());
}
...
const QString abt_transaction::getRemoteSuffix() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteSuffix(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteSuffix(const QString &Suffix)
{
        AB_Transaction_SetRemoteSuffix(this->m_aqb_transaction,
				       Suffix.toUtf8());
}
...
const QString abt_transaction::getRemoteIban() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteIban(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteIban(const QString &Iban)
{
        AB_Transaction_SetRemoteIban(this->m_aqb_transaction,
				     Iban.toUtf8());
}
...
const QStringList abt_transaction::getRemoteName() const
{
	return abt_conv::GwenStringListToQStringList(
                        AB_Transaction_GetRemoteName(this->m_aqb_transaction_C));
}
...
void abt_transaction::setRemoteName(const QStringList &Name)
{
	const GWEN_STRINGLIST *gwl = abt_conv::QStringListToGwenStringList(Name);
        ...
        AB_Transaction_SetRemoteName(this->m_aqb_transaction, gwl);
}
...
const QString abt_transaction::getRemoteBic() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteBic(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteBic(const QString &Bic)
{
        AB_Transaction_SetRemoteBic(this->m_aqb_transaction,
				    Bic.toUtf8());
}
...
const QDate abt_transaction::getValutaDate() const
{
	const GWEN_TIME *gwen_date;
        gwen_date = AB_Transaction_GetValutaDate(this->m_aqb_transaction_C);
...
{
        AB_Transaction_SetValutaDate(this->m_aqb_transaction,
...
{
	const GWEN_TIME *gwen_date;
        gwen_date = AB_Transaction_GetDate(this->m_aqb_transaction_C);
...
{
        AB_Transaction_SetDate(this->m_aqb_transaction,
...
{
        return AB_Transaction_GetValue(this->m_aqb_transaction_C);
}

void abt_transaction::setValue(const AB_VALUE *Value)
{
        AB_Transaction_SetValue(this->m_aqb_transaction,Value);
}
...
{
        return AB_Transaction_GetTextKey(this->m_aqb_transaction_C);
}

void abt_transaction::setTextKey(int TextKey)
{
        AB_Transaction_SetTextKey(this->m_aqb_transaction, TextKey);
}

int abt_transaction::getTextKeyExt() const
{
        return AB_Transaction_GetTextKeyExt(this->m_aqb_transaction_C);
}

void abt_transaction::setTextKeyExt(int TextKeyExt)
{
        AB_Transaction_SetTextKeyExt(this->m_aqb_transaction, TextKeyExt);
}
...
const QString abt_transaction::getTransactionKey() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetTransactionKey(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setTransactionKey(const QString &TransactionKey)
{
        AB_Transaction_SetTransactionKey(this->m_aqb_transaction,
...
const QString abt_transaction::getCustomerReference() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetCustomerReference(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setCustomerReference(const QString &CustomerReference)
{
        AB_Transaction_SetCustomerReference(this->m_aqb_transaction,
...
const QString abt_transaction::getBankReference() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetBankReference(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setBankReference(const QString &BankReference)
{
        AB_Transaction_SetBankReference(this->m_aqb_transaction,
...
const QString abt_transaction::getEndToEndReference() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetEndToEndReference(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setEndToEndReference(const QString &EndToEndReference)
{
        AB_Transaction_SetEndToEndReference(this->m_aqb_transaction,
...
const QString abt_transaction::getMandateReference() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetMandateReference(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setMandateReference(const QString &MandateReference)
{
        AB_Transaction_SetMandateReference(this->m_aqb_transaction,
...
const QString abt_transaction::getCreditorIdentifier() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetCreditorIdentifier(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setCreditorIdentifier(const QString &CreditorIdentifier)
{
        AB_Transaction_SetCreditorIdentifier(this->m_aqb_transaction,
...
const QString abt_transaction::getOriginatorIdentifier() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetOriginatorIdentifier(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setOriginatorIdentifier(const QString &OriginatorIdentifier)
{
        AB_Transaction_SetOriginatorIdentifier(this->m_aqb_transaction,
...
{		
        return AB_Transaction_GetTransactionCode(this->m_aqb_transaction_C);
}

void abt_transaction::setTransactionCode(int TransactionCode)
{
        AB_Transaction_SetTransactionCode(this->m_aqb_transaction,
					  TransactionCode);
}
...
const QString abt_transaction::getTransactionText() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetTransactionText(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setTransactionText(const QString &TransactionText)
{
        AB_Transaction_SetTransactionText(this->m_aqb_transaction,
...
const QString abt_transaction::getPrimanota() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetPrimanota(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setPrimanota(const QString &Primanota)
{
        AB_Transaction_SetPrimanota(this->m_aqb_transaction,
				    Primanota.toUtf8());
}
...
const QString abt_transaction::getFiId() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetFiId(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setFiId(const QString &FiId)
{
        AB_Transaction_SetFiId(this->m_aqb_transaction,
			       FiId.toUtf8());
}
...
{
	return abt_conv::GwenStringListToQStringList(
                        AB_Transaction_GetPurpose(this->m_aqb_transaction_C));
}
...
void abt_transaction::setPurpose(const QStringList &Purpose)
{
	const GWEN_STRINGLIST *gwl = abt_conv::QStringListToGwenStringList(Purpose);
        ...
        AB_Transaction_SetPurpose(this->m_aqb_transaction, gwl);
}

const QStringList abt_transaction::getCategory() const
{
	return abt_conv::GwenStringListToQStringList(
                        AB_Transaction_GetCategory(this->m_aqb_transaction_C));
}
...
void abt_transaction::setCategory(const QStringList &Category)
{
	const GWEN_STRINGLIST *gwl = abt_conv::QStringListToGwenStringList(Category);
        ...
        AB_Transaction_SetCategory(this->m_aqb_transaction, gwl);
}
...
{
        return AB_Transaction_GetPeriod(this->m_aqb_transaction_C);
}

void abt_transaction::setPeriod(AB_TRANSACTION_PERIOD Period)
{
        AB_Transaction_SetPeriod(this->m_aqb_transaction, Period);
}


int abt_transaction::getCycle() const
{
        return AB_Transaction_GetCycle(this->m_aqb_transaction_C);
}

void abt_transaction::setCycle(int Cycle)
{
        AB_Transaction_SetCycle(this->m_aqb_transaction, Cycle);
}

int abt_transaction::getExecutionDay() const
{
        return AB_Transaction_GetExecutionDay(this->m_aqb_transaction_C);
}

void abt_transaction::setExecutionDay(int ExecutionDay)
{
        AB_Transaction_SetExecutionDay(this->m_aqb_transaction, ExecutionDay);
}
...
{
	const GWEN_TIME *gwen_date;
        gwen_date = AB_Transaction_GetFirstExecutionDate(this->m_aqb_transaction_C);
...
{
        AB_Transaction_SetFirstExecutionDate(this->m_aqb_transaction,
					     abt_conv::QDateToGwenTime(Date));
}
...
{
	const GWEN_TIME *gwen_date;
        gwen_date = AB_Transaction_GetLastExecutionDate(this->m_aqb_transaction_C);
...
{
        AB_Transaction_SetLastExecutionDate(this->m_aqb_transaction,
					    abt_conv::QDateToGwenTime(Date));
}
...
{
	const GWEN_TIME *gwen_date;
        gwen_date = AB_Transaction_GetNextExecutionDate(this->m_aqb_transaction_C);
...
{
        AB_Transaction_SetNextExecutionDate(this->m_aqb_transaction,
					    abt_conv::QDateToGwenTime(Date));
}
...
{
        return AB_Transaction_GetType(this->m_aqb_transaction_C);
}

void abt_transaction::setType(AB_TRANSACTION_TYPE Type)
{
        AB_Transaction_SetType(this->m_aqb_transaction, Type);
}


AB_TRANSACTION_SUBTYPE abt_transaction::getSubType() const
{
        return AB_Transaction_GetSubType(this->m_aqb_transaction_C);
}
void abt_transaction::setSubType(AB_TRANSACTION_SUBTYPE SubType)
{
        AB_Transaction_SetSubType(this->m_aqb_transaction, SubType);
}


AB_TRANSACTION_STATUS abt_transaction::getStatus() const
{
        return AB_Transaction_GetStatus(this->m_aqb_transaction_C);
}

void abt_transaction::setStatus(AB_TRANSACTION_STATUS Status)
{
        AB_Transaction_SetStatus(this->m_aqb_transaction, Status);
}


AB_TRANSACTION_CHARGE abt_transaction::getCharge() const
{
        return AB_Transaction_GetCharge(this->m_aqb_transaction_C);
}

void abt_transaction::setCharge(AB_TRANSACTION_CHARGE Charge)
{
        AB_Transaction_SetCharge(this->m_aqb_transaction, Charge);
}
...
const QString abt_transaction::getRemoteAddrStreet() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteAddrStreet(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteAddrStreet(const QString &RemoteAddrStreet)
{
        AB_Transaction_SetRemoteAddrStreet(this->m_aqb_transaction,
...
const QString abt_transaction::getRemoteAddrZipcode() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteAddrZipcode(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteAddrZipcode(const QString &RemoteAddrZipcode)
{
        AB_Transaction_SetRemoteAddrZipcode(this->m_aqb_transaction,
...
const QString abt_transaction::getRemoteAddrCity() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemoteAddrCity(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemoteAddrCity(const QString &RemoteAddrCity)
{
        AB_Transaction_SetRemoteAddrCity(this->m_aqb_transaction,
...
const QString abt_transaction::getRemotePhone() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetRemotePhone(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setRemotePhone(const QString &RemotePhone)
{
        AB_Transaction_SetRemotePhone(this->m_aqb_transaction,
				      RemotePhone.toUtf8());
}
...
const QString abt_transaction::getUnitId() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetUnitId(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setUnitId(const QString &UnitId)
{
        AB_Transaction_SetUnitId(this->m_aqb_transaction, UnitId.toUtf8());
}
...
const QString abt_transaction::getUnitIdNameSpace() const
{
	QString ret;
	ret = QString::fromUtf8(
                AB_Transaction_GetUnitIdNameSpace(this->m_aqb_transaction_C));
	return ret;
}

void abt_transaction::setUnitIdNameSpace(const QString &UnitIdNameSpace)
{
        AB_Transaction_SetUnitIdNameSpace(this->m_aqb_transaction,
...
{
        return AB_Transaction_GetUnits(this->m_aqb_transaction_C);
}

void abt_transaction::setUnits(const AB_VALUE *Units)
{
        AB_Transaction_SetUnits(this->m_aqb_transaction, Units);
}


const AB_VALUE* abt_transaction::getUnitPrice() const
{
        return AB_Transaction_GetUnitPrice(this->m_aqb_transaction_C);
}

void abt_transaction::setUnitPrice(const AB_VALUE *UnitPrice)
{
        AB_Transaction_SetUnitPrice(this->m_aqb_transaction, UnitPrice);
}


const AB_VALUE* abt_transaction::getCommission() const
{
        return AB_Transaction_GetCommission(this->m_aqb_transaction_C);
}

void abt_transaction::setCommission(const AB_VALUE *Commission)
{
        AB_Transaction_SetCommission(this->m_aqb_transaction, Commission);
}
...
{
        return AB_Transaction_GetUniqueId(this->m_aqb_transaction_C);
}
void abt_transaction::setUniqueId(quint32 id)
{
        AB_Transaction_SetUniqueId(this->m_aqb_transaction, id);
}

quint32 abt_transaction::getIdForApplication() const
{
        return AB_Transaction_GetIdForApplication(this->m_aqb_transaction_C);
}
void abt_transaction::setIdForApplication(quint32 id)
{
        AB_Transaction_SetIdForApplication(this->m_aqb_transaction, id);
}

quint32 abt_transaction::getGroupId() const
{
        return AB_Transaction_GetGroupId(this->m_aqb_transaction_C);
}
void abt_transaction::setGroupId(quint32 id)
{
        AB_Transaction_SetGroupId(this->m_aqb_transaction, id);
}

const AB_VALUE* abt_transaction::getFees() const
{
        return AB_Transaction_GetFees(this->m_aqb_transaction_C);
}
void abt_transaction::setFees(const AB_VALUE* value)
{
        AB_Transaction_SetFees(this->m_aqb_transaction, value);
}
